...
su - postgres -c "psql -f $BASERVER_HOME/data/postgresql/create_repository_postgresql.sql"
su - postgres -c "psql -f $BASERVER_HOME/data/postgresql/create_quartz_postgresql.sql"
su - postgres -c "psql -f $BASERVER_HOME/data/postgresql/create_jcr_postgresql.sql"
su - postgres -c "psql quartz -f $BASERVER_HOME/data/postgresql/dummy_quartz_table.sql"
